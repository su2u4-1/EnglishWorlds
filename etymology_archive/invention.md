...
> Inventionis applied to the contrivance and production of something, often mechanical, that did not before exist, for the utilization of powers of nature long known or lately discovered by investigation.Discoverybrings to light what existed before, but was not known. [Century Dictionary]  
> Invention指的是發明和生產某些以前不存在的機械設備，以利用長期以來已知或最近通過調查發現的自然力量。Discovery揭示了以前存在但未知的事物。[世紀詞典]  
