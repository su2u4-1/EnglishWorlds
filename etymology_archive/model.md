...
## model(n.)
1570年代，“按比例製作的相似物； 建築師的設計集合”，源自法語 modelle（16世紀，現代法語 modèle），源自意大利語 modello “模型，模具”，源自通俗拉丁語 \*modellus，源自拉丁語 modulus “小尺寸，標準”，是 modus “方式，尺寸”的小型化（源自 PIE 詞根 [*med-](https://www.etymonline.com/tw/word/*med-) “採取適當措施”）。 “作爲模仿或比較的標準，事物或人物作爲模式或類型”的意義始於1630年代。
...
---
## model(v.)
約於1600年，表示“詳細描述”（現已過時）； 1660年代，表示“用黏土或蠟塑造或模仿（某物）的形象”，源自 [model](https://www.etymonline.com/tw/word/model)（名詞）。早期的表述爲 modelize（約於1600年）。從1730年開始表示“按照一定方式構建或安排”。從1915年開始表示“擔任時裝模特，展示（服裝）”。相關詞彙： Modeled； [modeling](https://www.etymonline.com/tw/word/modeling)； modelled； modelling。

---
## model(adj.)
"作爲模型的； 值得作爲榜樣的"，1844年，來自 [model](https://www.etymonline.com/tw/word/model)（名詞）。Model railway 於1864年出現。
