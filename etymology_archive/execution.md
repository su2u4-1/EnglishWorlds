...
## execution(n.)
14世紀後期，“執行，實施； 執行（法律，法規等），實施（計劃等）”，來自盎格魯-法語 execucioun（13世紀後期），古法語 execucion “執行”（命令等），源自拉丁語 executionem（主格 executio）“完成”，動作名詞，來自 exequi/exsequi “跟隨”（見 [execute](https://www.etymonline.com/tw/word/execute)）。
